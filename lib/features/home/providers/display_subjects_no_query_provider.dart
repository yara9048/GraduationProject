...
import '../data/services/display_subjects_no_query_service.dart';

class DisplaySubjectsNoQueryProvider with ChangeNotifier {
  final DisplaySubjectsNoQueryService _service =
  DisplaySubjectsNoQueryService();

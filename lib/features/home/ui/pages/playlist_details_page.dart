...
class _PlaylistDetailsPageState
  ...
  Future<void> _subscribe() async {
    ...
    if (subscribeProvider.errorMessage !=
        null) {
      _showMessage(
        message:
        subscribeProvider.errorMessage!,
        color: Colors.red,
      );
    }
  }
  ...
  Future<void> _submitRating({
    ...
    if (ratingProvider.errorMessage !=
        null) {
      _showMessage(
        message:

...
class DisplayPlaylistBySubjectPage extends StatefulWidget {
  ...
  @override
  State<DisplayPlaylistBySubjectPage> createState() => _DisplayPlaylistBySubjectPageState();
}

class _DisplayPlaylistBySubjectPageState extends State<DisplayPlaylistBySubjectPage> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<DisplayPlaylistBySubjectProvider>().getPlaylists(id: widget.id);
    });
  }

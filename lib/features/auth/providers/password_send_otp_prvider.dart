...
class PasswordSendOtpPrvider with ChangeNotifier {
  final PasswordSendOtpService _service = PasswordSendOtpService();
  ...
  Future<void> sendotp({ required String email,  required String code}) async {
    ...
    try {
      PasswordSendOtpModel user = await _service.sendOtp(
